...
namespace DmrSoft.OnMuhasebe.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppDepolar_Subeler_SubeId",
                        column: x => x.SubeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppKasalar_Subeler_SubeId",
                        column: x => x.SubeId,
                        principalTable: "Subeler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kod = table.Column<string>(type: "VarChar(20)", maxLength: 20, nullable: false),
                    Ad = table.Column<string>(type: "VarChar(50)", maxLength: 50, nullable: false),
                    KdvOran = table.Column<int>(type: "Int", maxLength: 20, nullable: false),
                    BirimFiyat = table.Column<decimal>(type: "Money", nullable: false),
                    Barkod = table.Column<string>(type: "VarChar(128)", maxLength: 128, nullable: false),
                    BirimId = table.Column<Guid>(type: "UniqueIdentifier", nullable: false),
                    OzelKod1Id = table.Column<Guid>(type: "UniqueIdentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tarih = table.Column<DateTime>(type: "Date", maxLength: 16, nullable: false),
                    BrutTutar = table.Column<decimal>(type: "Money", maxLength: 16, nullable: false),
                    IndirimTutar = table.Column<decimal>(type: "Money", maxLength: 16, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppFaturalar_Subeler_SubeId",
                        column: x => x.SubeId,
                        principalTable: "Subeler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppFirmaParametreler_Subeler_SubeId",
                        column: x => x.SubeId,
                        principalTable: "Subeler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMakbuzlar_Subeler_SubeId",
                        column: x => x.SubeId,
                        principalTable: "Subeler",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakipNo = table.Column<string>(type: "VarChar(20)", maxLength: 20, nullable: false),
                    ...
                    CekHesapNo = table.Column<string>(type: "VarChar(20)", maxLength: 20, nullable: false),
                    BelgeNo = table.Column<string>(type: "VarChar(20)", maxLength: 20, nullable: false),
                    Vade = table.Column<DateTime>(type: "Date", nullable: false),
                    AsilBorclu = table.Column<string>(type: "VarChar(20)", maxLength: 20, nullable: false),
