...
public class OnMuhasebeBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        if (!hostingEnvironment.IsDevelopment())
        {
            ...
            {
                serverBuilder.AddProductionEncryptionAndSigningCertificate("openiddict.pfx", "2d3e0fd0-ea51-4988-88a0-6954461f5c60");
            });
        }
    }
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/DmrSoft.OnMuhasebe.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainSharedModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DmrSoft.OnMuhasebe.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeDomainModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DmrSoft.OnMuhasebe.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationContractsModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DmrSoft.OnMuhasebe.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<OnMuhasebeApplicationModule>(Path.Combine(hostingEnvironment.ContentRootPath, $"..{Path.DirectorySeparatorChar}DmrSoft.OnMuhasebe.Application"));
